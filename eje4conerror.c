...
int main(){
	...
	for (int i=1; ((energia_inicial> MINIMO_ENERGIA_REQUERIDA)|| (recurso_1_disponible> REQUERIDO_RECURSO_1) ||(recurso_2_disponible> REQUERIDO_RECURSO_2) || (recurso_3_disponible> REQUERIDO_RECURSO_3)); i= i+CONSUMO_ENERGIA_POR_CICLO){
		//= productos_producidos + PRODUCTOS_POR_CICLO;
